...
public interface GeoIPServiceSoap {
    ...
    @RequestWrapper(localName = "GetIpLocation", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetIpLocation")
    @ResponseWrapper(localName = "GetIpLocationResponse", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetIpLocationResponse")
    ...
    @RequestWrapper(localName = "GetIpLocation_2_0", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetIpLocation20")
    @ResponseWrapper(localName = "GetIpLocation_2_0Response", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetIpLocation20Response")
    ...
    @RequestWrapper(localName = "GetLocation", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetLocation")
    @ResponseWrapper(localName = "GetLocationResponse", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetLocationResponse")
    ...
    @RequestWrapper(localName = "GetCountryISO2ByName", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetCountryISO2ByName")
    @ResponseWrapper(localName = "GetCountryISO2ByNameResponse", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetCountryISO2ByNameResponse")
    ...
    @RequestWrapper(localName = "GetCountryNameByISO2", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetCountryNameByISO2")
    @ResponseWrapper(localName = "GetCountryNameByISO2Response", targetNamespace = "http://lavasoft.com/", className = "net.wbgeoip.GetCountryNameByISO2Response")
